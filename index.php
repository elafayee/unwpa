...
<body>
  ...
  <!-- Recent Events -->
  <div class="container-fluid recent-events">
      ...
      <div class="row m-0 p-0">
        <div class="d-flex justify-content-start">
          <div class="row m-0 p-0">
            ...
            <div class="col-sm-6 text-light  mt-3" style="font-size: 12px; line-height: 5px;">
          ...
          <div class="d-flex  justify-content-around my-4">
            <ul class="nav col-md-4list-unstyled text-light ">
              <li class="ms-3"><a class="text-primary" href="#"><img src="assets\social media\email.png" width="25px" alt=""></svg></a></li>
              <li class="ms-3"><a class="text-muted" href="#"><img src="assets\social media\facebook.png" width="20px" alt=""></a></li>
              <li class="ms-3"><a class="text-muted" href="#"><img src="assets\social media\twitter.png" width="25px" alt=""></a></li>
              <li class="ms-3"><a class="text-muted" href="#"><img src="assets\social media\instagram.png" width="20px" alt=""></a></li>
            </ul>
          </div>
        </div>
      </div>
